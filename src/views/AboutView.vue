    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          ...
          src="img/avatar.jpeg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Saya Putri Junita Andieni seorang siswa yang memiliki ketertarikan mendalam di bidang UI/UX Design 
            dan Web Development. Saya mampu bekerja secara individu maupun dalam kelompok, karena saya mudah beradaptasi 
            dengan siapapun. Selain itu, saya memiliki pengalaman dalam membangun aplikasi berbasis web menggunakan React, TypeScript, 
            dan Tailwind CSS. Saya senang menciptakan desain yang clean, user-friendly, dan mengoptimalkan pengalaman pengguna melalui struktur yang rapi dan intuitif.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Saat ini, saya bersekolah di SMKN 4 Bandung, di mana saya terus mengembangkan keterampilan 
            di bidang desain antarmuka dan pengembangan front-end. Saya menerapkan konsep Atomic Design dalam setiap proyek, 
            memastikan setiap komponen UI modular dan dapat digunakan kembali. Pengalaman saya mencakup menghubungkan aplikasi 
            dengan API, mengatur routing di React, serta pemanfaatan tools seperti @headlessui/react, heroicons, dan react-transition-group untuk meningkatkan tampilan dan interaksi aplikasi.
          </p>
        </div>
